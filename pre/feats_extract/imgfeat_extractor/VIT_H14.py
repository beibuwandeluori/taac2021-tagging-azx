...
class VITH14ACExtractor(nn.Module):
    def __init__(self, zero_head=False, vis=False):
        super(VITH14ACExtractor, self).__init__()
        ...
        pretrained_dir = "./feats_extract/imgfeat_extractor/checkpoint/imagenet21k_ViT-H_14.npz"
